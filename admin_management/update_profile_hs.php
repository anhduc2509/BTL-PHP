...
require_once 'conn.php';
                ...
                // if(!empty($ten) && !empty($diachi) && !empty($ngaysinh) && !empty( $cccd) && !empty($sdt) && !empty( $email) && !empty($mon) && isset($_POST["submit"])){
                    $sql = "SELECT * FROM `hocsinh` INNER JOIN `lop` ON `hocsinh`. `idLop` = `lop`.`idLop` WHERE `idHs` = '$id'";
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link active" href="students.php"
                                aria-expanded="false">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                            <form action="edit_profile_hs.php" class="form-horizontal form-material" method = "POST">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Mã giáo viên </label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name ="idHS" type="text" value = "<?php echo $id ?>" readonly 
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input value = "<?php echo $gioitinh ?>" id = "gioitinh" type="text" placeholder = "0123456789" class="form-control p-0 border-0" readonly>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <input value = " <?php echo $lop ?>" id = "mon" name ="lop" type="text" placeholder = "0123456789" class="form-control p-0 border-0" >
                                        </div>
                                    </div>
