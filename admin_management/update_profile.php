            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Sửa thông tin giáo viên</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                            <form action="edit_profile.php" class="form-horizontal form-material" method = "POST">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input value = "<?php echo $ten ?>" name ="ten" type="text" 
                                                class="form-control p-0 border-0"> 
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input value = "<?php echo $diachi ?>" name ="diachi" type="text" 
                                                class="form-control p-0 border-0"> 
                                        </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input value = "<?php echo $ngaysinh ?>" name ="ngaysinh" type="text" 
                                                class="form-control p-0 border-0"> 
                                        </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input value = "<?php echo $gioitinh ?>" id = "gioitinh" type="text" placeholder = "0123456789" class="form-control p-0 border-0" hidden>
                                            <select name= "gioitinh" class="form-select shadow-none p-0 border-0 form-control-line">
                                                <option id = "gt1" value = "Nam">Nam</option>
                                                <option id = "gt2" value = "Nữ">Nữ</option>
                                                <option id = "gt3" value = "Khác">Khác</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input value = "<?php echo $cccd ?>" name ="cccd" type="text" 
                                                class="form-control p-0 border-0">
                                        </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input value = "<?php echo $sdt ?>" name ="sdt" type="text"  class="form-control p-0 border-0">
                                        </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                        <input value = " <?php echo $idmon ?>" id = "mon" name ="mon" type="text" placeholder = "0123456789" class="form-control p-0 border-0" hidden>
                                        <select name= "idmon" class="form-select shadow-none p-0 border-0 form-control-line">
                                                <option id="1"  value = "1">Toán</option>
                                                <option id="2"  value = "2">Văn</option>
                                                <option id="3"  value = "3">Anh</option>
                                                <option id="4"  value = "4">Lý</option>
                                                <option id="5"  value = "5">Hóa</option>
                                                <option id="6"  value = "6">Sinh</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button type="submit" name = "submit" class="btn btn-success">
                                                <a style="color:white;" onclick = "return confirm('Bạn có muốn cập nhật !')">Cập nhật</a>
                                            </button>
                                            <!-- <button type="submit" name = "submit" class="btn btn-dark"><a href="list_profile.php" style="color:white;" >Quay Lại</a> </button> -->
