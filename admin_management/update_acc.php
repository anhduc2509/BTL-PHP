...
require_once 'conn.php';
                ...
                // if(!empty($ten) && !empty($diachi) && !empty($ngaysinh) && !empty( $cccd) && !empty($sdt) && !empty( $email) && !empty($mon) && isset($_POST["submit"])){
                    $sql = "SELECT `id_gv`, `account`, `password` FROM `accountgv` WHERE `id_gv` = $id";
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Sửa tài khoản giáo viên</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                            <form action="edit_acc.php" class="form-horizontal form-material" method = "POST">
                                    <input name ="idGV" type="text" value = "<?php echo $id ?>" readonly hidden class="form-control p-0 border-0"> 
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Tài khoản </label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name ="acc" type="text" value = "<?php echo $acc ?>" readonly 
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input value = "<?php echo $pass ?>" name ="pass" type="text" 
                                                class="form-control p-0 border-0"> 
                                        </div>
                                    </div>
