...
$sql = "SELECT `idGV`, `idMonHoc`, `HoTen`, `NgaySinh`, `GioiTinh`, `CCCD`, `SDT`, `Email`, `DiaChi` FROM `giaovien`";
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                <h5 class="page-title" style="font-weight: 650">Tài khoản giáo viên</h5>
                            </div>
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT `id_gv`, `account`, `password` FROM `accountgv`";
                                            $result = $conn -> query($sql);
                                            while($row = $result -> fetch_assoc()){
                                                $idGV = $row["id_gv"];
                                                $acc = $row["account"];
                                                ...
                                                <form action="" method="post">
                                                        ...
                                                        <td style="width:0">
                                                            <button type="" name="Xem" style = "color:white" class="btn btn-info">
                                                                <a href="update_acc.php?id='.$idGV.'" style = "color:white">Sửa</a>
                                                            </button>
                                                            <button type="" name="Xem" style = "color:white" onclick = "return confirm (\'Bạn có muốn xóa tài khoản này ?\')" class="btn btn-danger">
                                                                <a href="delete_acc.php?id='.$idGV.'" style = "color:white">Xóa</a>
                                                            </button>
                                                        </td>
                                                </form>                                         
                                                </tr>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h5 class="page-title" style="font-weight: 650">Tài khoản học sinh</h5>
                                </div>
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr style="alaign">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT `idHs`, `password` FROM `dang_nhap_hs` ";
                                            $result = $conn -> query($sql);
                                            while($row = $result -> fetch_assoc()){
                                                $idHS = $row["idHs"];
                                                $acc = $row["idHs"];
                                                ...
                                                <form action="" method="post">
                                                        ...
                                                        <td style="width:0">
                                                            <button type="" name="Xem" style = "color:white" class="btn btn-info">
                                                                <a href="update_acc_hs.php?id='.$idHS.'" style = "color:white">Sửa</a>
                                                            </button>
                                                            <button type="" name="Xem" style = "color:white" onclick = "return confirm (\'Bạn có muốn xóa tài khoản này ?\')" class="btn btn-danger">
                                                                <a href="delete_acc_hs.php?id='.$idHS.'" style = "color:white">Xóa</a>
                                                            </button>
                                                        </td>
                                                </form>                                         
                                                </tr>
