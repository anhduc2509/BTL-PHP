...
if(!empty($_POST['set'])){
    $timehoc = '';
    $timehoc = $_POST['tg'];
    $sql_update = "UPDATE thoigianhoc SET ki1 = '$timehoc' WHERE 1";
...
$sql = "SELECT `idHs`, `idLop`, `HoTen`, `NgaySinh`, `GioiTinh`, `CCCD`, `SDT`, `Email`, `DiaChi` FROM `hocsinh`";
                        ...
                        <input type="submit" name="set" value = "Set time">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM `hocsinh` INNER JOIN `lop` ON `hocsinh`. `idLop` = `lop`.`idLop`";
                                            $result = $conn -> query($sql);
                                            while($row = $result -> fetch_assoc()){
                                                $idHs = $row["idHs"];
                                                $ten = $row["HoTen"];
                                                ...
                                                <form action="" method="post">
                                                        ...
                                                        <td style="width:0">
                                                            <button type="" name="Xem" style = "color:white" class="btn btn-info">
                                                                <a href="update_profile_hs.php?id='.$idHs.'" style = "color:white">Sửa</a>
                                                            </button>
                                                            <button type="" name="Xem" style = "color:white" onclick = "return confirm (\'Bạn có muốn xóa học sinh này ?\')" class="btn btn-danger">
                                                                <a href="delete_profile_hs.php?id='.$idHs.'" style = "color:white">Xóa</a>
                                                            </button>
                                                        </td>
                                                </form>                                         
                                                </tr>
