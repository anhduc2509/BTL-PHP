                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr style="alaign">
                                            ...
                                            <th class="border-top-0">Số báo danh</th>
                                            <th class="border-top-0">Họ và tên</th>
                                            <th class="border-top-0">Địa chỉ</th>
                                            <th class="border-top-0">Giới tính</th>
                                            <th class="border-top-0">Tổng điểm</th>
                                            <th class="border-top-0">Khối</th>
                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            $sql = "SELECT `SBD`, `HoTen`, `NamSinh`, `GioiTinh`, `DiaChi`, `Khoi`, `Toan`, `Van`, `Anh`, `TongDiem`, `TrangThai`, `Lop` FROM `ds_xettuyen` ORDER BY `TongDiem` DESC, `Lop` ASC ";
                                            $result = $conn -> query($sql);
                                            while ($row = $result->fetch_assoc()){
