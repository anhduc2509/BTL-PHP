<?php
    ...
    $idHs=$_SESSION["idHs"];
    $sql_value= " SELECT * FROM diem INNER JOIN monhoc ON diem.idMonHoc=monhoc.idMonHoc WHERE idHs=$idHs";
    $query= mysqli_query($conn,$sql_value);
    $sql_value1 = "SELECT * FROM hocsinh WHERE idHs=$idHs";
    $query1=mysqli_query($conn,$sql_value1);
                                ...
                                <table class="table text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Tên môn</th>
                                            <th class="border-top-0">Điểm tx1</th>
                                            <th class="border-top-0">Điểm tx2</th>
                                            <th class="border-top-0">Điểm thi</th>
                                            <th class="border-top-0">Điểm trung bình môn</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            ...
                                            while($arr=mysqli_fetch_assoc($query)){?>
                                                <?php
                                                    $diemtb=($arr['tx1'] + $arr['tx2'] + $arr['thi']*2)/4;
                                                    $d +=$diemtb;
                                                    if ($arr['TenMon'] == 'Toán' ) {
                                                        $toan = round($diemtb,1);
                                                    }
                                                ...
                                                <tr>
                                                    <td><?php echo $i++; ?></td>
                                                    <td><?php echo $arr['TenMon']; ?></td>
                                                    <td><?php echo $arr['tx1']; ?></td>
                                                    <td><?php echo $arr['tx2']; ?></td>
                                                    <td><?php echo $arr['thi']; ?></td>
                                                    <td><?php echo round($diemtb,1); ?></td>
                                                </tr>
                                            <?php       
                                            }
                                        ?>
                                        <tr>
                                            <td colspan="5" style="text-align: right">Điểm tổng kết:</td>
                                            <td><?php echo round($dtk=$d/6,1); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="text-align: right">Học lực:</td>
                                            <td>
                                                <?php
                                                    if($dtk >= 8){
                                                        if ( $toan >= 8 || $van >= 8) {
